/*
  ...
  - Added the required column `label` to the `Grade` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Grade" ("createdAt", "description", "id", "schoolId", "updatedAt") SELECT "createdAt", "description", "id", "schoolId", "updatedAt" FROM "Grade";
DROP TABLE "Grade";
